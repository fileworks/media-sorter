...
**[`docs/README.md`](docs/README.md) is the map**, grouped by what you are trying
to find out. It is not reproduced here: an index in this file is one that is
loaded every session and drifts unnoticed.
