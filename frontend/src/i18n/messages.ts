export const en = {
  ...
  "stage.review.planNeeded": "Preview the changes first",
  "setup.adjustSettings": "Adjust settings (optional)",
  "review.showPlanSummary": "Plan summary",
  ...
  "config.folder.enableLocal": "Select Auto or a local model above",
  "config.folder.installLocal": "Install the selected local model above",
  ...
  "config.ai.explanation":
    "AI tagging adds keywords; categorization chooses folders. Both can be wrong. Check a small copy first; scores are not accuracy guarantees.",
  ...
  "config.ai.embed": "Store generated tags",
  ...
  "config.ai.machineWeak":
    "This machine is below the recommended minimum for local AI. You can still organize by date and review duplicates; no media is sent to a cloud service.",
  ...
  "config.ai.tier.lite": "Lite — CLIP{slow}",
  "config.ai.tier.standard": "Standard — SigLIP 2{slow}",
  "config.ai.tier.max": "Max — same SigLIP 2 model as Standard{slow}",
  ...
  "config.ai.hardwareChecking": "Detecting local AI hardware…",
  "config.ai.hardwareUnavailable":
    "Could not detect local AI hardware. Try again to set up local models.",
  ...
  "config.slider.moreSorted": "Lower score threshold (50%)",
  "config.slider.onlySure": "Higher score threshold (99%)",
  ...
  "footer.toSetup": "Continue to setup",
  ...
  "recipes.consolidate.label": "Organize or import media",
  "recipes.consolidate.description":
    "Combine scattered folders or add new photos and videos to your library. Copy into year and month folders, keeping original filenames.",
  "recipes.consolidate.consequence":
    "Copies into Year / Month without renaming. Review duplicate suggestions before running; similar photos need your acceptance. Unwanted copies go under _copies/, junk under _junk/. Source and reference folders stay unchanged. Renaming and preserved event folders are optional in Configure.",
  ...
  "config.ai.advanced": "Vocabulary and score thresholds",
  "config.ai.embedHelp":
    "Report only creates no extra files. XMP sidecars keep media unchanged; embedding needs permission to rewrite media.",
  "config.ai.writeReport": "Report only",
...
export const de: Record<MessageKey, string> = {
  "stage.plan.label": "Plan",
  "stage.review.planNeeded": "Zuerst die Änderungen berechnen",
  "setup.adjustSettings": "Einstellungen anpassen (optional)",
  "review.showPlanSummary": "Planübersicht",
  ...
  "config.folder.enableLocal": "Oben Automatisch oder ein lokales Modell auswählen",
  "config.folder.installLocal": "Das ausgewählte lokale Modell oben installieren",
  ...
  "config.ai.explanation":
    "KI-Tagging ergänzt Stichwörter; Kategorisierung wählt Ordner. Beide können falsch sein. Erst an einer kleinen Kopie prüfen; Bewertungen garantieren keine Genauigkeit.",
  ...
  "config.ai.embed": "Erzeugte Tags speichern",
  ...
  "config.ai.machineWeak":
    "Dieser Rechner unterschreitet die empfohlene Mindestleistung für lokale KI. Nach Datum ordnen und Duplikate prüfen bleibt möglich; keine Medien werden an einen Cloud-Dienst gesendet.",
  ...
  "config.ai.tier.lite": "Lite — CLIP{slow}",
  "config.ai.tier.standard": "Standard — SigLIP 2{slow}",
  "config.ai.tier.max": "Max — dasselbe SigLIP-2-Modell wie Standard{slow}",
  ...
  "config.ai.hardwareChecking": "Hardware für lokale KI wird erkannt…",
  "config.ai.hardwareUnavailable":
    "Die Hardware für lokale KI konnte nicht erkannt werden. Versuche es erneut, um lokale Modelle einzurichten.",
  "config.ai.modelStatusUnavailable":
  ...
  "config.slider.moreSorted": "Niedrigere Bewertungsschwelle (50 %)",
  "config.slider.onlySure": "Höhere Bewertungsschwelle (99 %)",
  ...
  "stage.configure.label": "Einrichten",
  ...
  "footer.toSetup": "Weiter zum Rezept",
  ...
  "recipes.consolidate.label": "Medien ordnen oder importieren",
  "recipes.consolidate.description":
    "Verstreute Ordner zusammenführen oder neue Fotos und Videos zur Bibliothek hinzufügen. Nach Jahr und Monat kopieren und die Dateinamen behalten.",
  "recipes.consolidate.consequence":
    "Kopiert nach Jahr / Monat ohne Umbenennen. Duplikatvorschläge vor dem Start prüfen; ähnliche Fotos brauchen deine Zustimmung. Überzählige Kopien landen unter _copies/, Ausschuss unter _junk/. Quell- und Referenzordner bleiben unverändert. Umbenennen und vorhandene Ereignisordner sind unter Konfigurieren optional.",
  ...
  "config.ai.advanced": "Vokabular und Bewertungsschwellen",
  "config.ai.embedHelp":
    "Nur im Bericht erzeugt keine Zusatzdateien. XMP-Sidecars lassen Medien unverändert; Einbetten erfordert die Erlaubnis, Medien umzuschreiben.",
  "config.ai.writeReport": "Nur im Bericht",
