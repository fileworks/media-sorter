export const en = {
  ...
  "plan.summary.detail": "{count} duplicate set(s) will be visible in the review workspace.",
  ...
  "plan.check.sources.detail": "{inputs} input(s) · {references} reference(s) checked",
  "plan.check.boundary": "Write boundary is explicit",
  "plan.check.boundary.safe": "Inputs and references remain read-only.",
  "plan.check.boundary.mutations": "{count} source mutation(s) are explicitly planned.",
  ...
  "plan.sequence.read.detail":
    "Scan {count} active input source(s) and use references only for comparison.",
  "plan.sequence.organize.title": "Organize and name",
  "plan.sequence.organize.detail":
    "Prepare {count} actionable file group(s) for their destinations.",
  "plan.sequence.duplicates.title": "Decide duplicates",
  "plan.sequence.duplicates.detail":
    "Keep {count} duplicate set(s) visible for an explicit decision.",
  "plan.sequence.write.title": "Write to one destination",
  "plan.sequence.write.detail": "After approval, transfer and verify {count} planned file(s).",
  ...
  "review.compare.selected": "Selected",
...
export const de: Record<MessageKey, string> = {
  ...
  "plan.check.sources.detail": "{inputs} Eingabe(n) · {references} Referenz(en) geprüft",
  "plan.check.boundary": "Schreibgrenze eindeutig",
  "plan.check.boundary.safe": "Quellen und Referenzen bleiben schreibgeschützt.",
  "plan.check.boundary.mutations": "{count} Änderung(en) an Quellen sind ausdrücklich geplant.",
  ...
  "plan.sequence.read.detail":
    "{count} aktive Quelle(n) scannen; Referenzen dienen nur dem Vergleich.",
  "plan.sequence.organize.title": "Ordnen und benennen",
  "plan.sequence.organize.detail": "{count} ausführbare Dateigruppe(n) für ihre Ziele vorbereiten.",
  ...
  "plan.sequence.write.detail":
    "Nach der Freigabe {count} geplante Datei(en) übertragen und verifizieren.",
  ...
  "review.compare.selected": "Ausgewählt",
